...
export default (appLocalConfig: AppLocalConfig) => {
  ...
  const nextValue = appLocalConfig.android.valuesV31Xml.windowSplashScreenBackground
  ...
  // Android 12+
  updateFileIfNeeded(`${appPath}/android/app/src/main/res/values-v31/styles.xml`)
  // Android 10/11
  updateFileIfNeeded(`${appPath}/android/app/src/main/res/values-v29/styles.xml`)
}
